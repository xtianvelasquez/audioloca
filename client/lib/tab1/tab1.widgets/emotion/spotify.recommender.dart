...
class EmotionSpotifyListView extends StatefulWidget {
  final List<SpotifyTrack> allTracks;

  const EmotionSpotifyListView({super.key, required this.allTracks});

  @override
  State<EmotionSpotifyListView> createState() => EmotionSpotifyListViewState();
}

class EmotionSpotifyListViewState extends State<EmotionSpotifyListView> {
